...
def main():
	original = cv2.imread('Original_image/' + original_image_file)
	lsbEncoded = cv2.imread('Encoded_image/lsb_' + original_image_file)
	dctEncoded = cv2.imread('Encoded_image/dct_' + original_image_file)
